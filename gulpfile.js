...
function browsersync() {
    browserSync.init({ // Инициализация Browsersync
        ...
        browser: 'D:\\Opera GX\\launcher.exe',
...
function scripts() {
    return src([ // Берём файлы из источников
        'node_modules/jquery/jquery.min.js', // Пример подключения библиотеки
...
function styles() {
    return src('app/css/' + '/style.' + preprocessor + '') // Выбираем источник: "app/sass/main.sass" или "app/less/main.less"
...
function buildcopy() {
    return src([ // Выбираем нужные файлы
        ...
        .pipe(dest('Cats-cards')) // Выгружаем в папку с финальной сборкой
}

function cleandist() {
    return del('Cats-cards/**/*', { force: true }) // Удаляем всё содержимое папки "dist/"
}
